...
var BootstrapTable = (function (_React$Component) {
  ...
  function BootstrapTable(props) {
    ...
    if (!Array.isArray(this.props.data)) {
      this.store = new _storeTableDataStore.TableDataStore(this.props.data.getData(), this.props.options.dataTotalSize);
      ...
      this.store = new _storeTableDataStore.TableDataStore(this.props.data, this.props.options.dataTotalSize);
    }
    ...
    value: function renderPagination() {
      if (this.props.pagination) {
        ...
        if (this.isRemoteDataSource()) {
          ...
          //dataSize = this.props.dataSize; //this.store.getDataNum();
